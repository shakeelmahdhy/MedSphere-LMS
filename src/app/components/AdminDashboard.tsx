    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-x-hidden">
      ...
      <aside
        className={`fixed top-0 left-0 z-40 h-screen bg-white border-r border-gray-200 transition-all duration-300 ${
          sidebarOpen ? 'translate-x-0 w-72 sm:w-64' : '-translate-x-full lg:translate-x-0 lg:w-20'
        }`}
      >
      ...
      {/* Main Content */}
      <div className={`min-w-0 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'}`}>
        {/* Top Header */}
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-3 lg:justify-between">
              <div className="flex items-center justify-between gap-3 lg:hidden">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <UserAvatar user={currentUser} className="w-9 h-9 shadow-md" />
                  </button>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center gap-4 ml-6">
                ...
                <div className="relative">
                  ...
                  {notificationsOpen && (
                    <div className="absolute right-0 mt-2 w-80 max-w-[calc(100vw-2rem)] bg-white rounded-xl shadow-2xl border border-gray-200 py-2 animate-scale-in max-h-[580px] overflow-hidden flex flex-col">
        ...
        {notificationsOpen && (
          <div className="lg:hidden fixed left-4 right-4 top-20 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 animate-scale-in max-h-[70vh] overflow-hidden flex flex-col z-50">
            <div className="px-4 py-2 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 flex-shrink-0">
              <h3 className="font-bold text-gray-900">Notifications</h3>
              <span className="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full">
                {unreadCount} New
