      ...
      <div className="relative z-10 w-full max-w-6xl grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="hidden lg:block text-white space-y-8 animate-slide-in-left">
          <div className="flex items-center gap-3 mb-8">
            <img src="/logo.svg" alt="Medsphere Logo" className="h-16 w-auto" />
          </div>
        ...
        <div className="w-full animate-slide-in-right">
          ...
          {/* Signup Card */}
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 border border-white/50 max-h-[88vh] overflow-y-auto custom-scrollbar">
            <div className="mb-6">
              ...
              <div className="mb-6">
                <div className="relative bg-gray-100 rounded-xl p-1 flex">
                  ...
                  <button
                    ...
                    className={`relative z-10 flex-1 py-3 px-2 sm:px-4 rounded-lg font-medium text-sm sm:text-base transition-all duration-300 ${
